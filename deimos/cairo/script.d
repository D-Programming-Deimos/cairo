...
static if (CairoHasScriptSurface) {
    extern(System) {
        ...
        void cairo_script_set_mode (cairo_device_t *script, CairoScriptMode mode);

        CairoScriptMode cairo_script_get_mode (cairo_device_t *script);
    ...
    static assert(0, "Cairo was not compiled with support for the CairScript backend");
}
