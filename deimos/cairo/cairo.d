...
extern(System) {
     ...
     * @CAIRO_STATUS_INVALID_STATUS: invalid value for an input #CairoStatus
     ...
     * @CAIRO_STATUS_INVALID_CONTENT: invalid value for an input #CairoContent
     * @CAIRO_STATUS_INVALID_FORMAT: invalid value for an input #CairoFormat
     ...
     * @CAIRO_STATUS_INVALID_SLANT: invalid value for an input #CairoFontSlant (Since 1.8)
     * @CAIRO_STATUS_INVALID_WEIGHT: invalid value for an input #CairoFontWeight (Since 1.8)
     ...
     *
     * #CairoStatus is used to indicate errors that can occur when
     * using Cairo. In some cases it is returned directly by functions.
     * but when using #cairo_t, the last error, if any, is stored in
     * the context and can be retrieved with cairo_status().
     *
     * New entries may be added in future versions.  Use CairoStatuso_string()
     * to get a human-readable representation of an error message.
     *
     * NOTE From Binder: changed from original C to actually make usage /more/ like the original usage. Instead of
     * CAIRO_STATUS_SUCCESS, use CairoStatus.Success, other wise, D would enforce CairoStatus.CAIRO_STATUS_SUCCESS
     * CamelCased in the process
     **/
    enum CairoStatus {
        Success = 0,
     ...
     * vs. opacity), or both.
     *
     * Note: The large values here are designed to keep #CairoContent
     * values distinct from #CairoFormat values so that the
     ...
     *
     * #CairoFormat is used to identify the memory format of
     * image data.
     *
     ...
     **/
    alias CairoStatus function(void* closure, const char* data, uint length) cairo_write_func_t;
     ...
     **/
    alias CairoStatus function(void* closure, const char* data, uint length) cairo_read_func_t;
    ...
    CairoStatus cairo_set_user_data (cairo_t *cr, const cairo_user_data_key_t *key, void *user_data, cairo_destroy_func_t destroy);
    ...
    void cairo_push_group_with_content (cairo_t *cr, CairoContent content);
    ...
    * To keep things simple, the operator descriptions here
    ...
    void cairo_set_operator (cairo_t *cr, CairoOperator op);
    ...
    void cairo_set_antialias (cairo_t *cr, CairoAntialias antialias);
    ...
    void cairo_set_line_cap (cairo_t *cr, CairoLineCap line_cap);
    ...
    void cairo_set_line_join (cairo_t *cr, CairoLineJoin line_join);
    ...
    /* Insideness testing */
    bool cairo_in_stroke (cairo_t *cr, double x, double y);

    bool cairo_in_fill (cairo_t *cr, double x, double y);

    bool cairo_in_clip (cairo_t *cr, double x, double y);
    ...
    CairoStatus cairo_font_options_status (cairo_font_options_t *options);

    void cairo_font_options_merge (cairo_font_options_t *options, const cairo_font_options_t *other);
    bool cairo_font_options_equal (const cairo_font_options_t *options, const cairo_font_options_t *other);

    ulong cairo_font_options_hash (const cairo_font_options_t *options);

    void cairo_font_options_set_antialias (cairo_font_options_t *options, CairoAntialias antialias);
    CairoAntialias cairo_font_options_get_antialias (const cairo_font_options_t *options);

    void cairo_font_options_set_subpixel_order (cairo_font_options_t *options, CairoSubpixelOrder subpixel_order);
    CairoSubpixelOrder cairo_font_options_get_subpixel_order (const cairo_font_options_t *options);

    void cairo_font_options_set_hint_style (cairo_font_options_t *options, CairoHintStyle hint_style);
    CairoHintStyle cairo_font_options_get_hint_style (const cairo_font_options_t *options);

    void cairo_font_options_set_hint_metrics (cairo_font_options_t *options, CairoHintMetrics hint_metrics);
    CairoHintMetrics cairo_font_options_get_hint_metrics (const cairo_font_options_t *options);

    void cairo_select_font_face (cairo_t *cr, const char *family, CairoFontSlant slant, CairoFontWeight weight);
    ...
    void cairo_show_text_glyphs (cairo_t *cr, const char *utf8, int utf8_len, const cairo_glyph_t *glyphs, int num_glyphs, const cairo_text_cluster_t *clusters, int num_clusters, CairoTextClusterFlags cluster_flags);
    ...
    CairoStatus cairo_font_face_status (cairo_font_face_t *font_face);
     ...
     *
     * #CairofontType is used to describe the type of a given font
    ...
    CairoFontType cairo_font_face_get_type (cairo_font_face_t *font_face);

    void * cairo_font_face_get_user_data (cairo_font_face_t *font_face, const cairo_user_data_key_t *key);

    CairoStatus cairo_font_face_set_user_data (cairo_font_face_t *font_face, const cairo_user_data_key_t *key, void *user_data, cairo_destroy_func_t destroy);
    ...
    CairoStatus cairo_scaled_font_status (cairo_scaled_font_t *scaled_font);

    CairoFontType cairo_scaled_font_get_type (cairo_scaled_font_t *scaled_font);

    void * cairo_scaled_font_get_user_data (cairo_scaled_font_t *scaled_font, const cairo_user_data_key_t *key);

    CairoStatus cairo_scaled_font_set_user_data (cairo_scaled_font_t *scaled_font, const cairo_user_data_key_t *key, void *user_data, cairo_destroy_func_t destroy);
    ...
    CairoStatus cairo_scaled_font_text_to_glyphs (cairo_scaled_font_t *scaled_font, double x, double y, const char *utf8, int utf8_len, cairo_glyph_t **glyphs, int *num_glyphs, cairo_text_cluster_t **clusters, int *num_clusters, CairoTextClusterFlags *cluster_flags);
    ...
    cairo_font_face_t * cairo_toy_font_face_create (const char *family, CairoFontSlant slant, CairoFontWeight weight);

    char * cairo_toy_font_face_get_family (cairo_font_face_t *font_face);

    CairoFontSlant cairo_toy_font_face_get_slant (cairo_font_face_t *font_face);

    CairoFontWeight cairo_toy_font_face_get_weight (cairo_font_face_t *font_face);
     ...
     * Since: 1.8
     **/
    alias CairoStatus function(cairo_scaled_font_t *scaled_font, cairo_t *cr, cairo_font_extents_t *extents) cairo_user_scaled_font_init_func_t;
     ...
     * Since: 1.8
     **/
    alias CairoStatus function(cairo_scaled_font_t *scaled_font, ulong glyph, cairo_t *cr, cairo_text_extents_t *extents) cairo_user_scaled_font_render_glyph_func_t;
     ...
     * uinteger. As such, it is advised that user-fonts keep their
     ...
     * Since: 1.8
     **/
    alias CairoStatus function(cairo_scaled_font_t *scaled_font, const char *utf8, int utf8_len, cairo_glyph_t **glyphs, int *num_glyphs, cairo_text_cluster_t **clusters, int *num_clusters, CairoTextClusterFlags *cluster_flags) cairo_user_scaled_font_text_to_glyphs_func_t;
     ...
     * Since: 1.8
     **/
    alias CairoStatus function(cairo_scaled_font_t *scaled_font, ulong unicode, ulong *glyph_index) cairo_user_scaled_font_unicode_to_glyph_func_t;
    ...
    CairoOperator cairo_get_operator (cairo_t *cr);

    cairo_pattern_t * cairo_get_source (cairo_t *cr);

    double cairo_get_tolerance (cairo_t *cr);

    CairoAntialias cairo_get_antialias (cairo_t *cr);

    bool cairo_has_current_point (cairo_t *cr);

    void cairo_get_current_point (cairo_t *cr, double *x, double *y);

    CairoFillRule cairo_get_fill_rule (cairo_t *cr);

    double cairo_get_line_width (cairo_t *cr);

    CairoLineCap cairo_get_line_cap (cairo_t *cr);

    CairoLineJoin cairo_get_line_join (cairo_t *cr);
     ...
     * portions (defined in #CairoPathDataType), since the data
    ...
    CairoStatus cairo_status (cairo_t *cr);

    char * cairo_status_to_string (CairoStatus status);
     ...
     *
     * #CairoDeviceType is used to describe the type of a given
    ...
    CairoDeviceType cairo_device_get_type (cairo_device_t *device);

    CairoStatus cairo_device_status (cairo_device_t *device);

    CairoStatus cairo_device_acquire (cairo_device_t *device);
    ...
    CairoStatus cairo_device_set_user_data (cairo_device_t *device, const cairo_user_data_key_t *key, void *user_data, cairo_destroy_func_t destroy);


    /* Surface manipulation */

    cairo_surface_t * cairo_surface_create_similar (cairo_surface_t *other, CairoContent content, int width, int height);

    cairo_surface_t * cairo_surface_create_similar_image (cairo_surface_t *other, CairoFormat format, int width, int height);
    ...
    cairo_surface_t * cairo_surface_create_observer (cairo_surface_t *target, CairoSurfaceObserverMode mode);

    alias void function(cairo_surface_t *observer, cairo_surface_t *target, void *data) cairo_surface_observer_callback_t;

    CairoStatus cairo_surface_observer_add_paint_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_add_mask_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_add_fill_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_add_stroke_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_add_glyphs_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_add_flush_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_add_finish_callback (cairo_surface_t *abstract_surface, cairo_surface_observer_callback_t func, void *data);

    CairoStatus cairo_surface_observer_print (cairo_surface_t *surface, cairo_write_func_t write_func, void *closure);
    double cairo_surface_observer_elapsed (cairo_surface_t *surface);

    CairoStatus cairo_device_observer_print (cairo_device_t *device, cairo_write_func_t write_func, void *closure);
    ...
    CairoStatus cairo_surface_status (cairo_surface_t *surface);
     ...
     *
     * #CairoSurfaceType is used to describe the type of a given
    ...
    CairoStatus cairo_surface_set_user_data (cairo_surface_t *surface, const cairo_user_data_key_t *key, void *user_data, cairo_destroy_func_t destroy);
    ...
    void cairo_surface_get_mime_data (cairo_surface_t *surface, const char *mime_type, const char **data, ulong *length);

    CairoStatus cairo_surface_set_mime_data (cairo_surface_t *surface, const char *mime_type, const char *data, ulong length, cairo_destroy_func_t destroy, void *closure);

    bool cairo_surface_supports_mime_type (cairo_surface_t *surface, const char *mime_type);
    ...
    cairo_surface_t * cairo_image_surface_create (CairoFormat format, int width, int height);

    int cairo_format_stride_for_width (CairoFormat format, int width);

    cairo_surface_t * cairo_image_surface_create_for_data (char *data, CairoFormat format, int width, int height, int stride);

    char * cairo_image_surface_get_data (cairo_surface_t *surface);

    CairoFormat cairo_image_surface_get_format (cairo_surface_t *surface);
    ...
    cairo_surface_t * cairo_recording_surface_create (CairoContent content, const cairo_rectangle_t *extents);

    void cairo_recording_surface_ink_extents (cairo_surface_t *surface, double *x0, double *y0, double *width, double *height);

    bool cairo_recording_surface_get_extents (cairo_surface_t *surface, cairo_rectangle_t *extents);
     ...
     * Since: 1.12
     **/
    alias cairo_surface_t * function(cairo_pattern_t *pattern, void *callback_data, cairo_surface_t *target, const cairo_rectangle_int_t *extents) cairo_raster_source_acquire_func_t;
     ...
     * Since: 1.12
     **/
    alias void function(cairo_pattern_t *pattern, void *callback_data, cairo_surface_t *surface) cairo_raster_source_release_func_t;
     ...
     * #CairoStatus error codes for failure.
     *
     * Since: 1.12
     **/
    alias CairoStatus function(cairo_pattern_t *pattern, void *callback_data) cairo_raster_source_snapshot_func_t;
     ...
     * Since: 1.12
     **/
    alias CairoStatus function(cairo_pattern_t *pattern, void *callback_data, const cairo_pattern_t *other) cairo_raster_source_copy_func_t;
     ...
     * Since: 1.12
     **/
    alias void function(cairo_pattern_t *pattern, void *callback_data) cairo_raster_source_finish_func_t;

    cairo_pattern_t * cairo_pattern_create_raster_source (void *user_data, CairoContent content, int width, int height);
    ...
    CairoStatus cairo_pattern_status (cairo_pattern_t *pattern);

    void * cairo_pattern_get_user_data (cairo_pattern_t *pattern, const cairo_user_data_key_t *key);

    CairoStatus cairo_pattern_set_user_data (cairo_pattern_t *pattern, const cairo_user_data_key_t *key, void *user_data, cairo_destroy_func_t destroy);
    ...
    CairoPatternType cairo_pattern_get_type (cairo_pattern_t *pattern);
    ...
    void cairo_mesh_pattern_set_corner_color_rgba (cairo_pattern_t *pattern, uint corner_num, double red, double green, double blue, double alpha);
     ...
     *
     * #CairoExtend is used to describe how pattern color/alpha will be
    ...
    void cairo_pattern_set_extend (cairo_pattern_t *pattern, CairoExtend extend);

    CairoExtend cairo_pattern_get_extend (cairo_pattern_t *pattern);
     ...
     *
     * #CairoFilter is used to indicate what filtering should be
    ...
    void cairo_pattern_set_filter (cairo_pattern_t *pattern, CairoFilter filter);

    CairoFilter cairo_pattern_get_filter (cairo_pattern_t *pattern);

    CairoStatus cairo_pattern_get_rgba (cairo_pattern_t *pattern, double *red, double *green, double *blue, double *alpha);

    CairoStatus cairo_pattern_get_surface (cairo_pattern_t *pattern, cairo_surface_t **surface);


    CairoStatus cairo_pattern_get_color_stop_rgba (cairo_pattern_t *pattern, int index, double *offset, double *red, double *green, double *blue, double *alpha);

    CairoStatus cairo_pattern_get_color_stop_count (cairo_pattern_t *pattern, int *count);

    CairoStatus cairo_pattern_get_linear_points (cairo_pattern_t *pattern, double *x0, double *y0, double *x1, double *y1);

    CairoStatus cairo_pattern_get_radial_circles (cairo_pattern_t *pattern, double *x0, double *y0, double *r0, double *x1, double *y1, double *r1);

    CairoStatus cairo_mesh_pattern_get_patch_count (cairo_pattern_t *pattern, uint *count);

    cairo_path_t * cairo_mesh_pattern_get_path (cairo_pattern_t *pattern, uint patch_num);

    CairoStatus cairo_mesh_pattern_get_corner_color_rgba (cairo_pattern_t *pattern, uint patch_num, uint corner_num, double *red, double *green, double *blue, double *alpha);

    CairoStatus cairo_mesh_pattern_get_control_point (cairo_pattern_t *pattern, uint patch_num, uint point_num, double *x, double *y);
    ...
    CairoStatus cairo_matrix_invert (cairo_matrix_t *matrix);
    ...
    bool cairo_region_equal (const cairo_region_t *a, const cairo_region_t *b);

    CairoStatus cairo_region_status (const cairo_region_t *region);
    ...
    bool cairo_region_is_empty (const cairo_region_t *region);

    CairoRegionOverlap cairo_region_contains_rectangle (const cairo_region_t *region, const cairo_rectangle_int_t *rectangle);

    bool cairo_region_contains_point (const cairo_region_t *region, int x, int y);

    void cairo_region_translate (cairo_region_t *region, int dx, int dy);

    CairoStatus cairo_region_subtract (cairo_region_t *dst, const cairo_region_t *other);

    CairoStatus cairo_region_subtract_rectangle (cairo_region_t *dst, const cairo_rectangle_int_t *rectangle);

    CairoStatus cairo_region_intersect (cairo_region_t *dst, const cairo_region_t *other);

    CairoStatus cairo_region_intersect_rectangle (cairo_region_t *dst, const cairo_rectangle_int_t *rectangle);

    CairoStatus cairo_region_union (cairo_region_t *dst, const cairo_region_t *other);

    CairoStatus cairo_region_union_rectangle (cairo_region_t *dst, const cairo_rectangle_int_t *rectangle);

    CairoStatus cairo_region_xor (cairo_region_t *dst, const cairo_region_t *other);

    CairoStatus cairo_region_xor_rectangle (cairo_region_t *dst, const cairo_rectangle_int_t *rectangle);
